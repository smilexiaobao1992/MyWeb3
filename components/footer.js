export default function MyFooter() {
    return (<footer class="footer footer-center p-10 bg-primary text-primary-content mb-0">
    <div>
      ...
      <p class="font-bold">
      Braveguozhi.eth. <br/>Providing reliable tech since 1992
      </p> 
      <p>Copyright © 2023 - All right reserved braveguozhi.eth</p>
    </div> 
    <div>
